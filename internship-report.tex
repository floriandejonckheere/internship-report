...
\begin{document}
  ...
  \section{Responsibilities and assignments}
    ...
    The full description of the principles and conventions is written down in a document called the \textit{Project Charter}.
    ...
    \florian{
      \begin{itemize}
        \item \textbf{Deployment}: implementation of the web application's runtime environment. 
              The deployment procedure uses Docker and Docker Compose to create a reproducible and stable build of the product.
        ...
        \item \textbf{CoCOS}: a major assignment was the setup and maintenance of the CoCOS project site (\href{https://www.cocos.education/}{https://www.cocos.education/}) and digital learning environment (\href{https://my.cocos.education/}{https://my.cocos.education/}) in collaboration with international partners.
              The project website comes in the form of a self-hosted WordPress application, while the digital learning environment is a self-hosted software package called Moodle.
      \end{itemize}
    }
